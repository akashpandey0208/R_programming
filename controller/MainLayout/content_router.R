...
#' @param sub_menu Character: 'data_upload' or 'data_operations'
#' @return HTML div with data management module content
render_data_management_module <- function(sub_menu = "data_upload") {
  if (!is.null(sub_menu) && sub_menu == "data_operations") {
    study_table_ui("study_table")
  } else {
    data_upload_folder_ui("data_upload_folder")
  }
}
